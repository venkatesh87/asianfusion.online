...
//
// this code loads the parent's stylesheet
//
function enqueue_styles() {
  ...
  wp_enqueue_script( $client_script, get_template_directory_uri() . '/client-script.js', array('jquery'), '1.0.0', true );
}
...
require_once ALLSOL_THEME_DIR . 'woocommerce-customizations.php';
