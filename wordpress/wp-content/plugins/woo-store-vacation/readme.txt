...
Go to WooCommerce > Store Vacation > Enable Vacation Mode.
Check the setting to enable it.
Fill in a temporary shop announcement.
Click Save Settings.

= How to turn off vacation mode? =
Go to WooCommerce > Store Vacation > Enable Vacation Mode.
Uncheck the setting to disable it.
